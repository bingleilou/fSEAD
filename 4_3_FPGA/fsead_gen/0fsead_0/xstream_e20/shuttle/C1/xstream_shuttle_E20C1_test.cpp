...
#include <stdlib.h>
#include <math.h>
#include "xstream_shuttle_E20C1.h"
...
int main(int argc, char **argv)
{
    ...
    for (int isample=0; isample < SMAPLE_NUM; isample++) {
        ...
        for (int idim=0; idim < DIM_MAX; idim++) {
            ...
            data_str << data_str_bus;
                xstream_shuttle_c1(data_str, score_xstream);
    ...
    rval = write_file_1D<float, SMAPLE_NUM>("D:/HLS/0fsead_0/xstream_e20/shuttle/C1/data/score_xstream_shuttle", tb_score_xstream);
}