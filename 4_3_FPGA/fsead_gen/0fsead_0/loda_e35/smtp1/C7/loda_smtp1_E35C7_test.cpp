...
int main(int argc, char **argv)
{
    ...
    for (int isample=0; isample < SMAPLE_NUM; isample++) {
        ...
        for (int idim=0; idim < DIM_MAX; idim++) {
            ...
            data_str << data_str_bus;
                loda_smtp1_c7(data_str, score_loda);
    ...
    rval = write_file_1D<float, SMAPLE_NUM>("D:/HLS/0fsead_0/loda_e35/smtp1/C7/data/score_loda_smtp1", tb_score_loda);
}