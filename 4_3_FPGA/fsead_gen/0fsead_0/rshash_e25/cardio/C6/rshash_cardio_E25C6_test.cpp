...
int main(int argc, char **argv)
{
    ...
    for (int isample=0; isample < SMAPLE_NUM; isample++) {
        ...
        for (int idim=0; idim < DIM_MAX; idim++) {
            ...
            data_str << data_str_bus;
                rshash_cardio_c6(data_str, score_rshash);
    ...
    rval = write_file_1D<float, SMAPLE_NUM>("D:/HLS/0fsead_0/rshash_e25/cardio/C6/data/score_rshash_cardio", tb_score_rshash);
}