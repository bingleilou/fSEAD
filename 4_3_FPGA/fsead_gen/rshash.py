    ...
    def init_stream(self, X, y):
        ...
        if self.save_en != '0':
            ...
            for r in range(7):
                ...
                print_params_rshash(data_path, param_name_hls, base_num, self.dim, self.batch_size, self.num_hash, self.matrix_col, alpha_print[r*base_num:(r+1)*base_num], f_print[r*base_num:(r+1)*base_num], minimum_print, max_min_print, bottom_print, peak_bottom_print)
...
if __name__ == '__main__':
    ...
    if save_en != '0':
        data_hls_path = "0fsead_0/data_hls/rshash/"
        ...
        data_gcc_path = "0gcc_0/data_gcc/rshash/"
        save_X_name = "{data_name}_X".format(data_name=data_name)
        save_y_name = "{data_name}_y".format(data_name=data_name)
    ...
    model_scores = np.array(model_scores).ravel()
