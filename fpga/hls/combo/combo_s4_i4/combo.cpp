...
void combo_score_i4(
	...
	data_IN4 = IN4.read();
	score_in4 = (interface_t)data_IN4.data;


	accum_t combo_regression = (accum_t)(((accum_t)score_in1 + (accum_t)score_in2 + (accum_t)score_in3 + (accum_t)score_in4)*(accum_t)0.25);
