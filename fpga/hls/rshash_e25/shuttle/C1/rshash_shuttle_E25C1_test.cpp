...
#include <stdlib.h>
#include <math.h>
#include "rshash_shuttle_E25C1.h"
...
int main(int argc, char **argv)
{
    ...
    for (int isample=0; isample < SMAPLE_NUM; isample++) {
        ...
        for (int idim=0; idim < DIM_MAX; idim++) {
            ...
            data_str << data_str_bus;
                rshash_shuttle_c1(data_str, score_rshash);
    ...
    rval = write_file_1D<float, SMAPLE_NUM>("D:/HLS/0fsead_0/rshash_e25/shuttle/C1/data/score_rshash_shuttle", tb_score_rshash);
}