...
cd $CURDIR/gcc && python3 loda_gcc_gen.py --data_name cardio
cd $CURDIR/gcc && python3 loda_gcc_gen.py --data_name shuttle
cd $CURDIR/gcc && python3 loda_gcc_gen.py --data_name smtp1
cd $CURDIR/gcc && python3 loda_gcc_gen.py --data_name http1
cd $CURDIR/gcc && python3 rshash_gcc_gen.py --data_name cardio
cd $CURDIR/gcc && python3 rshash_gcc_gen.py --data_name shuttle
cd $CURDIR/gcc && python3 rshash_gcc_gen.py --data_name smtp1
cd $CURDIR/gcc && python3 rshash_gcc_gen.py --data_name http1
cd $CURDIR/gcc && python3 xstream_gcc_gen.py --data_name cardio
cd $CURDIR/gcc && python3 xstream_gcc_gen.py --data_name shuttle
cd $CURDIR/gcc && python3 xstream_gcc_gen.py --data_name smtp1
cd $CURDIR/gcc && python3 xstream_gcc_gen.py --data_name http1
