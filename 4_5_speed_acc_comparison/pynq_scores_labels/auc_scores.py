...
y_benchmark_path="./../../4_3_FPGA/fsead_gen/0gcc_0/data_gcc/{data_name}_y".format(ad=detector, data_name=data_name)
...
score_path="./{ad}_{data_name}_7".format(ad=detector, data_name=data_name)
